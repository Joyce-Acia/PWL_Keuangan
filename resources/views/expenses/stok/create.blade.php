<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Create Expense Stok') }}</h2>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('expense-stok.store') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="stok" value="{{ old('stok') }}" class="mt-1 block w-full" placeholder="Nama stok/item" required>
                        </div>

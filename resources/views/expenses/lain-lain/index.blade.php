                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-bold">Expenses Lain-Lain</h3>
                            <a href="{{ route('expense-lain-lain.create') }}"
                                        ...
                                        @foreach($expenses as $expense)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <a href="{{ route('expense-lain-lain.edit', $expense) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                                    <form action="{{ route('expense-lain-lain.destroy', $expense) }}" method="POST" class="inline-block ml-3" onsubmit="return confirm('Hapus expense ini?');">
                                                        @csrf
                                                        @method('DELETE')
